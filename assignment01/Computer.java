...
/**
 * Class to store information about a personal computer with the basic
 * information stored in an advertisement for a computer.
 * 
 * @author CS 140
 *
 */
public class Computer {
	 ...
	 * @param cpuDesc
	 *            brief description of the cpu of this computer
	 * @param ram
	 *            amount of ram in GB in this computer
	 * @param disk
	 *            size of hard drive in GB in this computer
	 * @param ssd
	 *            true if the hard drive is solid state
	 * @param purchPrice
	 *            the purchase price of this computer
	 */
	...
	/**
	 * The toString method is overridden to provide a summary of this computer. If
	 * the hard drive is larger than one terabyte, the String contains the disk size
	 * in terabytes. The purchase price is formatted as the expected
	 * dollars-and-cents. The description changes when the disk is solid state or a
	 * normal hard drive.
	 */
	@Override
	public String toString() {
		...
		return String.format(brand + ", " + cpuDescription + ", " + ramGB + "GB Memory, " + diskStr + "Price: $%.2f ",
				purchasePrice);
	}
}
